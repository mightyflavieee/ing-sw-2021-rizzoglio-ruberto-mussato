...
class TakeMarketResourcesMoveTest {
    ...
    void twoResourcesInShef2(){
        ...
        assertEquals(ResourceType.Shield,resourceList1Gian.get(1).getType());
        Warehouse warehouse1Gian = new Warehouse(null);
    ...
    void opponentsForward(){
       ...
       // warehouse1Gian.getShelves().get(ShelfFloor.Second).add(new Resource(ResourceType.Servant));
        ...
        Move move1Gian = new TakeMarketResourcesMove(warehouse1Gian, discardedResources, localMarket, false);
        assertTrue(move1Gian.isFeasibleMove(match));
        move1Gian.performMove(match);
        assertEquals(0,gianluca.getMarkerPosition());
        assertEquals(1,flavio.getMarkerPosition());
        assertEquals(1, leo.getMarkerPosition());
