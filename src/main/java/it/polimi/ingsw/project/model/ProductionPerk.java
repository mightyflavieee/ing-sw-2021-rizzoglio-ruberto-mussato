...
public class ProductionPerk extends Perk{
  ...
  private ResourceType chooseWhichResourceToEliminate() {
    ...
    System.out.println("Which it.polimi.ingsw.project.model.Resource would you want to use for the production?\n1. Coin;\n2. Shield;\n3. Servant;\n4. Stone.");
    try {
  ...
  private Resource chooseResourceToProduce() {
    System.out.println("Which it.polimi.ingsw.project.model.Resource do you want?\n1. Coin;\n2. Shield;\n3. Servant;\n4. Stone.\n(You will also advance 1 position in the Faith Map!)");
    BufferedReader reader = new BufferedReader(new InputStreamReader(System.in));
